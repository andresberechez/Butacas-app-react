...
const CarteleraInhabilitadaPage = () => {
  const { clientesAfectado, inhabilitarCartelera } = useButacas();
...
export default CarteleraInhabilitadaPage;
